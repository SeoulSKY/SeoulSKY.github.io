...
function About(){
  return (
    <>
      ...
      >
        I'm a skilled software developer with experience in Python, C#, Rust, TypeScript and JavaScript, specializing in frameworks like React.js, React Native, Node.js and Unity3D.
